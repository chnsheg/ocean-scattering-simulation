    ...
    : QObject{parent}
{
    if (!loadFromJsonFile("constants1.json"))
    {
        ...
        m_constants.insert(constantMap->getConstantName(1, 0), 532e-9);
        m_constants.insert(constantMap->getConstantName(1, 1), 1.0);
        m_constants.insert(constantMap->getConstantName(1, 2), 10e-12);
        m_constants.insert(constantMap->getConstantName(1, 3), 10e-6);
