    ...
    : QObject{parent}
{
    ...
    if ((!loadFromJsonFile("constants.json")) || debug == true)
    {
        ...
        m_constants.insert(constantMap->getConstantName(0, 0), 333333333);
        ...
        m_constants.insert(constantMap->getConstantName(0, 4), 80e-3);
        ...
        m_constants.insert(constantMap->getConstantName(1, 3), 1.4e-3);
        m_constants.insert(constantMap->getConstantName(1, 4), 1.34); // 水折射率
        ...
        m_constants.insert(constantMap->getConstantName(7, 0), 10000);
        m_constants.insert(constantMap->getConstantName(7, 1), 0.05);
        m_constants.insert(constantMap->getConstantName(7, 2), 0.6);
        m_constants.insert(constantMap->getConstantName(7, 3), 0.8);
        m_constants.insert(constantMap->getConstantName(7, 4), 1.25);
        m_constants.insert(constantMap->getConstantName(7, 5), 2);
        m_constants.insert(constantMap->getConstantName(7, 6), 100);
        m_constants.insert(constantMap->getConstantName(7, 7), 400000);
        m_constants.insert(constantMap->getConstantName(7, 8), 1);
